...
let contactInfo=[
  [
  {text1:"Email",mode1:"cussupport@savvy.com"},
...
function Table({first}){
  ...
  <tbody>
    <tr>
      <td>{first==1?contactInfo[0][0].text1:contactInfo[1][0].text1}</td>
      <td><a href="#">{first==1?contactInfo[0][0].mode1:contactInfo[1][0].mode1}</a></td>
    </tr>
    <tr>
    <td>{first==1?contactInfo[0][1].text2:contactInfo[1][1].text2}</td>
      <td>
        {first==1?contactInfo[0][1].mode2:(<a href="#">{contactInfo[1][1].mode2}</a>)} {first==1&&"(Available 24x7)"}
      </td>
    </tr>
  </tbody>
</table>
